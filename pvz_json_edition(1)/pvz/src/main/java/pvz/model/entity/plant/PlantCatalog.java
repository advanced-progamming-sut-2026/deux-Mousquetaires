...
public final class PlantCatalog {
    ...
    public static final class Stats {
        ...
        public final float range;            // in cells; 9 = whole lane
        public final PlantFamily family;
        public final EnumSet<PlantTag> tags;
        public final String description;
        public final String plantFoodEffect; // sheet "Plant Food Effect"
        public final String[] upgrades;      // sheet "Level 2" / "Level 3" / "Level 4"
    ...
    private static void loadFromJson() {
        ...
        if (file == null) {
            System.out.println("[!] data/plants.json not found - using built-in plant stats.");
            return;}
        try {
            ...
            System.out.println("[!] Could not read plant JSON data (" + e.getMessage() + ") - using built-in stats.");
        }
    }
    /// json
