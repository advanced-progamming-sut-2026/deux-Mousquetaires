...
public class QuestManager {
    ...
    public void printPage(String page) {
        ...
        if (onPage.isEmpty()) {
            System.out.println("No quests on page '" + page + "'.");
            return;
        }
        onPage.sort(Comparator.comparing(Quest::getPriority));
        System.out.println("=== Travel Log – " + page + " ===");
        for (Quest quest : onPage) System.out.println(quest.describe());
        System.out.println("Claim finished quests with: claim <quest_id>");
    }
